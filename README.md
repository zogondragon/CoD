...
Also, there is a very famous oriental fantasy novel called The Heaven Sword and The Dragon Saber(1961, Jin Yong). The historical and fantasy settings provided by this book is very detailed and inspiring. However, the references in this game to the oriental fantasy novels will not be limited to the works of Jin Yong.

Basic Mechanism
---------------
In contrast to other Turn-Based Strategy (TBS) games or Strategic Role-Playing Games (SRPG), CoD is focused on *the clan* instead of *the country*. It means that you can be a clan leader such as Zhang Sanfeng(장삼봉, 무당파) and change the course of history beside the curtain.
...
The victory is obtained when the (hmm.... I have to think about it )
